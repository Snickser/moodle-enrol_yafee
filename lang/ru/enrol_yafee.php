...
$string['forcepayment_help'] = 'Если установлено, форма оплаты, доступная по ссылке в период порога уведомления, будет отображаться игнорируя установленные даты начала или конца зачисления в курс.';
...
$string['uninterrupted_desc'] = 'Цена за курс сформирована с учётом пропущенного времени неоплаченного периода.';
