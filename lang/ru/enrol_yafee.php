...
$string['costerror'] = 'Стоимость должна быть указана в виде числа больше ноля.';
...
Чтобы продлить обучение перейдите на {$a->payurl}
';
...
$string['expirynotifyperiod_desc'] = 'Отправка уведомления о приостановке доступа к курсу после истечении срока зачисления. Данный параметр должен быть равен периоду выполнения планировщика отправки уведомлений enrol_yafee\task\send_expiry_notifications, если меньше - сообщения отправляться не будут, если больше - они будут отправляться несколько раз.';
$string['extremovedsuspendnoroles'] = 'Приостановить участие в курсе и удалить роли';
$string['forcepayment'] = 'Игнорировать даты зачисления в курс';
...
$string['uninterrupted_warn'] = '<font color=red>Работает только в платёжных модулях bePaid, Robokassa, YooKassa!</font>';
